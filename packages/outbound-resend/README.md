<p align="center">
  <h1 align="center">@dsar/outbound-resend</h1>
</p>
...
Resend-backed notification adapter implementing the DSAR notification adapter contract.

## Installation

```bash
bun add @dsar/outbound-resend
```
...
**Built with 💛 by the [inth.com](https://www.inth.com?utm_source=github&utm_medium=repopage_%40dsar%2Foutbound-resend) team**
