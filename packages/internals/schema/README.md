<p align="center">
  <a href="https://dsar-sdk.dev?utm_source=github&utm_medium=repopage_%40dsar%2Fschema" target="_blank" rel="noopener noreferrer">
    <picture>
  ...
  <br />
  <h1 align="center">@dsar/schema</h1>
</p>
...
Canonical DSAR domain types and Effect Schema runtime contracts.

## Key Features

- Runtime validation schemas for request, policy, verification, fulfillment, delivery, appeals, retention, lifecycle, and audit contracts.
- Inferred TypeScript types generated directly from the schemas.
- Stable contract exports for backend, SDK, CLI, and UI consumers.

## Usage

```ts
import { RequestSchema, type DsarRequest } from "@dsar/schema";
import * as Schema from "effect/Schema";

const parsed = Schema.decodeUnknownSync(RequestSchema)(payload);
```

1. Versioning and stability: see docs/architecture/contracts-and-versioning.md for public-stable vs internal-evolving contracts and semver policy.
...
**Built with 💛 by the [inth.com](https://www.inth.com?utm_source=github&utm_medium=repopage_%40dsar%2Fschema) team**
