<p align="center">
  <a href="https://dsar-sdk.dev?utm_source=github&utm_medium=repopage_%40dsar%2Fpolicy-engine" target="_blank" rel="noopener noreferrer">
    <picture>
  ...
  <br />
  <h1 align="center">@dsar/policy-engine</h1>
</p>
...
Deterministic policy-pack schema and evaluator interface for DSAR jurisdiction logic.

## Key Features

- Effect Schema policy-pack validation.
- Effect service interface for deterministic evaluation.
- Machine-readable explainability traces (clock, actions, notices, matched rules).
- Fixture-based regression tests for UK/EU/US-style vectors.
...
**Built with 💛 by the [inth.com](https://www.inth.com?utm_source=github&utm_medium=repopage_%40dsar%2Fpolicy-engine) team**
