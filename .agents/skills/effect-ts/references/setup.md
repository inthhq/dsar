...
1. Add `https://github.com/Effect-TS/effect` on branch `main` as a git subtree with squashed history at `./.repos/effect`
2. Add `https://github.com/Effect-TS/effect` on branch `main` as a git submodule at `./.repos/effect`
...
- Source: `https://github.com/Effect-TS/effect`, branch `main`
