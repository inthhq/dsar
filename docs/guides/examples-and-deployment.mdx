...
| `examples/dashboard`                 | Operator queue using `@dsar/react` against kitchen-sink                       | Local operator UI                                      |
| `examples/subject-portal`            | Subject portal using `@dsar/react` against kitchen-sink                       | File and list requests in the browser                  |
