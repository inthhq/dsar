...
| `@dsar/core`                | Stable application-facing client contract with `managed` and `self-hosted` HTTP-backed modes, `custom` handler-driven mode, and `offline` fixture-backed mode; see [docs/developer/sdk-and-runtime.md](../developer/sdk-and-runtime.md) |
