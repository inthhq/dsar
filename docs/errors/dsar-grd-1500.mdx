---
title: "DSAR-GRD-1500: GUARDS_RUNTIME_ERROR"
description: "An unhandled guards runtime exception occurred."
...
An unhandled guards runtime exception occurred.

## Probable Causes

- Unexpected bug in guard evaluation logic.
...
Any uncaught exception thrown during guard evaluation.
