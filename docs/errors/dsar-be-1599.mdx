---
title: "DSAR-BE-1599: INTERNAL_UNCATALOGED_ERROR"
description: "The runtime emitted an error code that is not present in the backend catalog and fell back to uncataloged handling."
