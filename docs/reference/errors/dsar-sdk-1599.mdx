---
title: "DSAR-SDK-1599: SDK_UNCATALOGED_ERROR"
description: "The SDK emitted an error code that is not present in the SDK catalog and fell back to uncataloged handling."
...
1. Add the missing code to SDK catalog.
